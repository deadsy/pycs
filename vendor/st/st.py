...
_STM32F407xx_altfunc = (
  ...
  ('B', 0, 2, 'TIM3_CH3'),
  ('B', 0, 3, 'TIM8_CH2N'),
  ('B', 0, 10, 'OTG_HS_ULPI_D1'),
  ('B', 0, 11, 'ETH_MII_RXD2'),
  ('B', 0, 15, 'EVENTOUT'),
  ('B', 1, 1, 'TIM1_CH3N'),
  ('B', 1, 2, 'TIM3_CH4'),
  ('B', 1, 3, 'TIM8_CH3N'),
  ('B', 1, 10, 'OTG_HS_ULPI_D2'),
  ('B', 1, 11, 'ETH_MII_RXD3'),
  ('B', 1, 15, 'EVENTOUT'),
  ('B', 2, 15, 'EVENTOUT'),
  ('B', 3, 0, 'JTDO/TRACESWO'),
  ...
  ('B', 9, 15, 'EVENTOUT'),
  ('B', 10, 1, 'TIM2_CH3'),
  ('B', 10, 5, 'SPI2_SCK/I2S2_CK'),
  ('B', 11, 1, 'TIM2_CH4'),
  ('B', 12, 1, 'TIM1_BKIN'),
  ('B', 12, 5, 'SPI2_NSS/I2S2_WS'),
  ('B', 13, 1, 'TIM1_CH1N'),
  ('B', 13, 5, 'SPI2_SCK/I2S2_CK'),
  ('B', 14, 1, 'TIM1_CH2N'),
  ('B', 14, 5, 'SPI2_MISO'),
  ('B', 15, 1, 'TIM1_CH3N'),
  ('B', 15, 5, 'SPI2_MOSI/I2S2_SD'),
  ('C', 2, 5, 'SPI2_MISO'),
  ('C', 3, 5, 'SPI2_MOSI/I2S2_SD'),
  ('C', 6, 5, 'SPI2_MOSI/I2S2_MCK'),
  ('C', 7, 2, 'TIM3_CH2'),
  ('C', 7, 3, 'TIM8_CH2'),
  ('C', 7, 6, 'I2S3_MCK'),
  ('C', 7, 8, 'USART6_RX'),
...
_STM32F427xx_altfunc = (
  ...
  ('G', 2, 12, 'FMC_A12'),
  ('G', 3, 12, 'FMC_A13'),
  ('G', 4, 12, 'FMC_A14/FMC_BA0'),
  ('G', 5, 12, 'FMC_A15/FMC_BA1'),
  ('G', 6, 14, 'LCD_R7'),
  ('G', 7, 14, 'LCD_CLK'),
  ('G', 8, 12, 'FMC_SDCLK'),
  ('G', 9, 8, 'USART6_RX'),
